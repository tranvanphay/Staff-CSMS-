...
import com.phaytran.staffcsms.App


class SharedPrefs private constructor() {
    private val mSharedPreferences: SharedPreferences = App.self()!!.getSharedPreferences(Constants.PREF_NAME, Context.MODE_PRIVATE)
